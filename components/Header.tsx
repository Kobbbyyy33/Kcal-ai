    ...
    <header className="sticky top-0 z-40 border-b border-white/70 bg-white/80 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/75">
      <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-3">
        <div className="min-w-0">
          <img src="/brand/Lime%20Green%20Modern%20Health%20%26%20Fitness%20Logo%20(1).png" alt="KcalIA" className="h-9 w-auto object-contain" />
          <div className="truncate text-xs text-slate-500 dark:text-slate-400">{title} · Coach nutrition quotidien</div>
        </div>
