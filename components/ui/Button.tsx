  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" &&
          "bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-[0_10px_24px_rgba(16,185,129,0.35)] hover:brightness-105 disabled:from-emerald-400 disabled:to-emerald-400",
        variant === "ghost" &&
